...
/**
* Interface for iterators of pseudorandom numbers drawn from a Weibull distribution.
*/
...
* // ...
*/
declare function iterator( k: number, lambda: number, options?: Options ): RandIter; // tslint:disable-line:max-line-length
